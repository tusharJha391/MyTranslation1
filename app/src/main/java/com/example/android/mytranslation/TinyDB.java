...
public class TinyDB {
    ...
    public ArrayList<Object> getListObject(String key, ArrayList<TranslationFav> mClass){
    	Gson gson = new Gson();
    ...
    public void putListObject(String key, ArrayList<TranslationFav> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
